...
public class Main {
    ...
    System.out.println("Total price for all houses: " + houseService.getTotalPriceForHousing(houseService.allHouses));
    ...
    System.out.println("Average square meters for all houses: " + houseService.getAverageSquareMetersForHousing(houseService.allHouses));
